...
vi /usr/local/bin/fix-dns-configuration.sh
----
#!/bin/bash
...
# WORKING SCENARIO:
# Resolve custom host
address=/myexternalendpoint.com/10.224.0.92
EOF
...
sudo vi /usr/local/bin/update-dns-configuration.sh
---
#!/bin/bash
...
sudo systemctl restart dnsmasq
---
sudo chmod +x /usr/local/bin/update-dns-configuration.sh
